            ...
            menu.disabled
              ...
              : menu.action == activeId
                ? (
                    <View
                      key={menu.action}
                      style={{ ...styles.menuItem, width: menuItemStyle.width, height: menuItemStyle.height, backgroundColor: theme['c-primary-dark-200'] }}
                    >
                      <Text style={{ textAlign: center ? 'center' : 'left' }} color="#FFFFFF" size={fontSize} numberOfLines={1}>{menu.label}</Text>
                    </View>
                  )
                : (
                    <TouchableHighlight
