    ...
    disabled
      ? (
          <View style={contentStyle}>
            ...
            <View style={labelStyle}>{label ? <Text style={styles.name} color={theme['c-500']} size={13 * size}>{label}</Text> : children}</View>
            {helpComponent}
          </View>
        )
      : (
          <View style={contentStyle}>
            ...
            <TouchableOpacity style={labelStyle} activeOpacity={0.3} onPress={handleLabelPress}>
              {label ? <Text style={styles.name} size={13 * size}>{label}</Text> : children}
            </TouchableOpacity>
            {helpComponent}
          </View>
        )
