...
export interface OnlineListProps {
  ...
  onLocateCurrent?: ListProps['onLocateCurrent']
  progressViewOffset?: ListProps['progressViewOffset']
  ListHeaderComponent?: ListProps['ListHeaderComponent']
  checkHomePagerIdle?: boolean
  locateBtnBottom?: ListProps['locateBtnBottom']
  locateBtnVisible?: ListProps['locateBtnVisible']
  rowType?: RowInfoType
}
...
export default forwardRef<OnlineListType, OnlineListProps>(({
  ...
  useImperativeHandle(ref, () => ({
    ...
    scrollToCurrent() {
      listRef.current?.scrollToCurrent()
    },
    scrollToInfo(info) {
    ...
    <View style={styles.container}>
      <View style={{ flex: 1 }}>
        <List
          ...
          locateBtnBottom={locateBtnBottom}
          locateBtnVisible={locateBtnVisible}
          rowType={rowType}
        />
        <MultipleModeBar
