...
export default async(setting: LX.AppSetting) => {
  ...
  global.lx.isEnableSyncLog = setting['other.isEnableSyncLog']
  global.lx.isEnableUserApiLog = setting['other.isEnableUserApiLog']
  ...
  const handleConfigUpdate = (keys: Array<keyof LX.AppSetting>, setting: Partial<LX.AppSetting>) => {
    if (keys.includes('other.isEnableSyncLog')) {
      global.lx.isEnableSyncLog = setting['other.isEnableSyncLog']!
    }
    if (keys.includes('other.isEnableUserApiLog')) {
      global.lx.isEnableUserApiLog = setting['other.isEnableUserApiLog']!
    }
    if (keys.includes('theme.dynamicBg')) {
