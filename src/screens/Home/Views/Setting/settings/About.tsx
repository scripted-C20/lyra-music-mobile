...
const repoLicenseUrl = `${repoUrl}#%E9%A1%B9%E7%9B%AE%E5%8D%8F%E8%AE%AE`
...
export default memo(() => {
  ...
  const t = useI18n()
  const openHomePage = () => {
    void openUrl(repoReadmeUrl)
  }
  const openIssuePage = () => {
    void openUrl(repoIssuesUrl)
  }
  const openGHReleasePage = () => {
    void openUrl(repoReleasesUrl)
  }
  const openFAQPage = () => {
  ...
  return (
    <Section title={t('setting_about')} icon="logo" description={t('setting_section_desc_about')}>
